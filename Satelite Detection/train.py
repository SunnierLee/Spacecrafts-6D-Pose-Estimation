...
if __name__ == "__main__":
    ...
    Cuda = True
    classes_path = 'model_data/satellite_classes.txt'
    ...
    save_dir = 'logs_regdet_oriaug_small_224_uncertainty50'

    num_workers = 48

    #   获得图片路径和标签
    train_annotation_path = 'satellite_detection_train_best.txt'
    val_annotation_path = 'satellite_detection_val_best.txt'
